...
model_20=LinearModel(train_df[train_df.sub_area=='Poselenie Novofedorovskoe'], TwoClassModel)
...
model_81=LinearModel(train_df[train_df.sub_area=='Severnoe Izmajlovo'],TwoClassModel)
...
model_86=LinearModel(train_df[train_df.sub_area=='Jakimanka'],TwoClassModel)
